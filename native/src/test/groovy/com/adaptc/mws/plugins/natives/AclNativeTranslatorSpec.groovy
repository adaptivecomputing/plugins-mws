...
class AclNativeTranslatorSpec extends Specification {
	...
	def "Test parse ACL Rules: #desc"() {
		...
		"USER==!BILL="											|"modifier"													|0			|AclReportType.USER		|ReportComparisonOperator.EQUAL					|true			|false		|false		|false			|false			|"BILL"		|AclReportAffinity.NEUTRAL
		"USER==BI!LL="											|"misplaced modifier"										|0			|AclReportType.USER		|ReportComparisonOperator.EQUAL					|false			|false		|false		|false			|false			|"BI!LL"	|AclReportAffinity.NEUTRAL
		"USER==^~BILL="											|"2 modifiers"												|0			|AclReportType.USER		|ReportComparisonOperator.EQUAL					|false			|false		|true		|false			|true			|"BILL"		|AclReportAffinity.NEUTRAL
