...
class NodeUtilizationReportPluginSpec extends Specification {
		...
		1 * moabRestService.get({
			...
			return true
				...
				[id:"node04", lastUpdateDate:"12:12:12 01-01-01", totalMemory:100, availableMemory:75,
						state:NodeReportState.IDLE.toString(), genericMetrics:[cpuUtilization:50], attributes:[MOAB_DATACENTER:"myDC"]],
	...
	def "Test node event '#errorMessage' is thrown with api-version 2"() {
		...
		1 * moabRestService.post( "/rest/events", {
			...
			assert result.sourceComponent == "NodeUtilizationReportPlugin"
		...
		"ERROR"		| "nodeUtilizationReportPlugin.node.name.null"							| [lastUpdatedDate: "12:12:12 01-01-01", resources: [memory: [real: 100, available: 80]], states: [state: NodeReportState.IDLE.toString()], metrics: [cpuUtilization: 45], attributes: [ MOAB_DATACENTER: "datacenter"] ]
		"ERROR"		| "nodeUtilizationReportPlugin.node.state.null"							| [name: "node1", lastUpdatedDate: "12:12:12 01-01-01", resources: [memory: [real: 100, available: 80]], states: [state: null], metrics: [cpuUtilization: 45],attributes: [ MOAB_DATACENTER: "datacenter"] ]
		"ERROR"		| "nodeUtilizationReportPlugin.node.realMemory.null"					| [name: "node1", lastUpdatedDate: "12:12:12 01-01-01", resources: [memory: [available: 80]], states: [state: NodeReportState.IDLE.toString()], metrics: [cpuUtilization: 45], attributes: [ MOAB_DATACENTER: "datacenter"] ]
		"ERROR"		| "nodeUtilizationReportPlugin.total.memory.zero.message"				| [name: "node1", lastUpdatedDate: "12:12:12 01-01-01", resources: [memory: [real: 0, available: 40]], states: [state: NodeReportState.IDLE.toString()], metrics: [cpuUtilization: 45], attributes: [ MOAB_DATACENTER: "datacenter"] ]
		"ERROR"		| "nodeUtilizationReportPlugin.node.availableMemory.null"				| [name: "node1", lastUpdatedDate: "12:12:12 01-01-01", resources: [memory: [real: 100]], states: [state: NodeReportState.IDLE.toString()], metrics: [cpuUtilization: 45], attributes: [ MOAB_DATACENTER: "datacenter"] ]
		"ERROR"		| "nodeUtilizationReportPlugin.node.cpuUtils.null"						| [name: "node1", lastUpdatedDate: "12:12:12 01-01-01", resources: [memory: [real: 100, available: 80]], states: [state: NodeReportState.IDLE.toString()], attributes: [ MOAB_DATACENTER: "datacenter"] ]
		"WARN"		| "nodeUtilizationReportPlugin.available.equals.total.memory.message"	| [name: "node1", lastUpdatedDate: "12:12:12 01-01-01", resources: [memory: [real: 80, available: 80]], states: [state: NodeReportState.IDLE.toString()], metrics: [cpuUtilization: 45], attributes: [ MOAB_DATACENTER: "datacenter"] ]
		"WARN"		| "nodeUtilizationReportPlugin.cpu.zero.message"						| [name: "node1", lastUpdatedDate: "12:12:12 01-01-01", resources: [memory: [real: 100, available: 80]], states: [state: NodeReportState.IDLE.toString()], metrics: [cpuUtilization: 0], attributes: [ MOAB_DATACENTER: "datacenter"] ]
		"WARN"		| "nodeUtilizationReportPlugin.node.notUpdated"							| [name: "node1", lastUpdatedDate: "12:12:12 01-01-00", resources: [memory: [real: 100, available: 80]], states: [state: NodeReportState.IDLE.toString()], metrics: [cpuUtilization: 45], attributes: [ MOAB_DATACENTER: "datacenter"] ]
